          ...
          <View style={styles.sbBillContent}>
            ...
            <View style={[{ marginTop: 10 }, styles.table]}>
              <View style={[styles.tableRow, styles.tableHeader]}>
                <Text
                  style={[{ width: "10%", fontWeight: "600" }, styles.tableCol]}
                >
                  S/N
                </Text>
                <Text
                  style={[{ width: "25%", fontWeight: "600" }, styles.tableCol]}
                >
                  Date Paid
                </Text>
                <Text
              ...
              {tuition?.payments
                ...
                .map((obj, index) => (
                  <View key={index} style={styles.tableRow}>
                    <Text style={[{ width: "10%" }, styles.tableColContent]}>
                      {index + 1}
                    </Text>
                    <Text style={[{ width: "25%" }, styles.tableColContent]}>
              ...
              <View
                style={[styles.tableRow, styles.tableHeader, { marginTop: 10 }]}
              >
                <Text
                  style={[{ width: "34%", fontWeight: "600" }, styles.tableCol]}
                >
                  Total Bill
                </Text>
                <Text
                  style={[{ width: "33%", fontWeight: "600" }, styles.tableCol]}
                >
                  Total Amount Paid
                </Text>
                <Text
